...
1. Push this source to GitHub.
2. Create a Railway project and connect it to your GitHub repository.
3. Add the environment variables from `.env.example` (especially `MONGO_URI` and `JWT_SECRET`).
4. Railway will automatically build and deploy the app using the included `railway.json`.
